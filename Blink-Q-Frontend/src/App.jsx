...
import ChatBoxLobby from "./pages/chatbox/ChatboxLobby.jsx";
import ChatBox from "./pages/chatbox/ChatComponents/ChatBox.jsx";
        ...
        <div className="flex flex-1">
          ...
          <main className="flex-1 p-4 overflow-y-auto">
            ...
            <Routes>
              ...
              <Route path="/chatlobby" element={<ChatBoxLobby />} />
